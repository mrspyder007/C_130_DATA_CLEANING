...
df= pd.read_csv("final.csv")#reading data using pandas family code
print(df.shape)#cheacking total columns, rows
...
print(df.shape)#cheacking total columns, rows[2nd time]
print(list(df))#checking list of headers



#converting shortform names into long names for better understanding
df=df.rename({
...
print(list(df))#checking list of headers[2nd time]

df.to_csv("main.csv")#creating .csv file